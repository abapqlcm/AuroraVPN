...
import io.github.abapqlcm.auroravpn.core.DnsMap
import io.github.abapqlcm.auroravpn.core.HevEngineSettings
import io.github.abapqlcm.auroravpn.core.HevTun2SocksConfig
import io.github.abapqlcm.auroravpn.core.HevTun2SocksEngine
import io.github.abapqlcm.auroravpn.core.HevTun2SocksNative
import io.github.abapqlcm.auroravpn.core.PsiphonController
import io.github.abapqlcm.auroravpn.core.RoutingEngine
import io.github.abapqlcm.auroravpn.core.SocksTunBridge
...
class AetherVpnService : VpnService() {
    ...
    companion object {
        const val ACTION_START = "io.github.abapqlcm.auroravpn.ACTION_START"
        const val ACTION_STOP = "io.github.abapqlcm.auroravpn.ACTION_STOP"
        const val ACTION_RESTART = "io.github.abapqlcm.auroravpn.ACTION_RESTART"
        const val ACTION_SWITCH_HEV = "io.github.abapqlcm.auroravpn.SWITCH_HEV"
    ...
    private suspend fun switchHevInternal(host: String, port: Int) {
        ...
        var switchCfg: io.github.abapqlcm.auroravpn.shared.model.AetherConfig? = null
            ...
            val notification = NotificationCompat.Builder(this, ALERT_CHANNEL_ID)
                ...
                .setStyle(
                    NotificationCompat.BigTextStyle()
                        .bigText("AuroraVPN was disconnected unexpectedly.\nReason: $reason\n\nTap 'Reconnect' to restore your secure connection.")
                )
                .setSmallIcon(R.drawable.ic_stat_aether)
                .setAutoCancel(true)
                .setContentIntent(contentIntent)
    ...
    private fun createNotificationChannel() {
        val statusChannel = NotificationChannel(CHANNEL_ID, "AuroraVPN", NotificationManager.IMPORTANCE_DEFAULT).apply {
            setSound(null, null)
            enableVibration(false)
            enableLights(false)
            setShowBadge(false)
        }
        val alertChannel = NotificationChannel(ALERT_CHANNEL_ID, "AuroraVPN Alerts", NotificationManager.IMPORTANCE_HIGH).apply {
